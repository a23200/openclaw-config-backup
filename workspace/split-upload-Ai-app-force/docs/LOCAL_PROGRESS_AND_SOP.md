...
```bash
curl http://localhost:3001/api/builds/012e97e3-cf85-4578-99d2-eb23d4add303/status
```
...
```bash
curl http://localhost:3001/api/builds/012e97e3-cf85-4578-99d2-eb23d4add303/status | jq '.error,.logs[-50:]'
```
...
```bash
curl -X POST http://localhost:3001/api/builds/012e97e3-cf85-4578-99d2-eb23d4add303
```
