...
- `scripts/build_comic_manga_ppt.py`：漫画风 PPT 专用 Gemini 真生图脚本
...
- `./.venv/bin/python scripts/build_comic_manga_ppt.py --source /path/to/source.md`
...
- `漫画风 PPT`：上传文档后走 `参考图 + Gemini 真生图 + 图文融合 + 动态页数 + 实时进度` 专用流程
