...
class XianyuLive:
    ...
    def __init__(self, cookies_str=None, cookie_id: str = "default", user_id: int = None):
        ...
        self.auto_local_browser_captcha_enabled = cfg.get('LOCAL_BROWSER_CAPTCHA', {}).get('auto_open_background', False)
    ...
    async def _handle_captcha_verification(self, res_json: dict) -> str:
        ...
        try:
            ...
            if self.auto_local_browser_captcha_enabled:
                ...
                logger.info(f"【{self.cookie_id}】后台验证码不再自动接管本机Chrome，仅记录/通知验证链接")
