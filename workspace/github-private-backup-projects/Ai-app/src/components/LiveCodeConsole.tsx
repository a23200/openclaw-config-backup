        ...
        <div className="flex items-center gap-2">
          ...
          <Badge
            ...
            className={cn(
              ...
              streamState === "fallback" && "border-amber-400/20 bg-amber-400/10 text-amber-200",
            )}
          >
          ...
          <div className="flex h-full flex-col items-center justify-center gap-4 px-8 text-center text-slate-400">
            ...
            <div>
              <p className="text-sm font-medium text-slate-200">
                {streamState === "fallback" ? "流式预览已暂停" : "正在等待 AI 代码流"}
              </p>
              <p className="mt-2 max-w-md text-xs leading-6 text-slate-400">
                {streamState === "fallback"
                  ? "当前模型暂未返回可实时预览的代码片段，系统已切到普通生成模式；完整结果返回后，这里会一次性填充代码内容。"
