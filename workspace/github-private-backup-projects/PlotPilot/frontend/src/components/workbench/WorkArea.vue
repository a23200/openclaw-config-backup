      ...
      <div v-else class="managed-stack">
        ...
        <div class="autopilot-container managed-autopilot">
          <AutopilotPanel
            ...
            @chapter-start="handleChapterStart"
            @chapter-chunk="handleChapterChunk"
...
function handleChapterStart(chapterNumber: number) {
  streamingChapterNumber.value = chapterNumber
  streamingContent.value = ''

  if (currentChapter.value && currentChapter.value.number === chapterNumber) {
    chapterContent.value = ''
  }
}

function handleChapterChunk(data: { chapterNumber: number; chunk: string; beatIndex: number; content: string }) {
