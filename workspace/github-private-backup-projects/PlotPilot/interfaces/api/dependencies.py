...
def get_article_topic_analyzer():
    """短文题目分析服务(约 1 万字短文的轻量 1 次 LLM 结构推断)。"""
    from application.article.services.article_topic_analyzer import ArticleTopicAnalyzer
    return ArticleTopicAnalyzer(llm_service=get_llm_service())
