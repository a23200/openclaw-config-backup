        ...
        try:
            ...
            try:
                if self.root and self.root.winfo_exists():
                    ...
                    # root 已销毁，用纯终端输出兜底
                    print(f"\n[FATAL] {e}\n{tb}")
                    show_fatal_console(f"小说创作家 异常: {e}", tb[-2000:])
            except Exception:
                # 连弹窗都失败了，写文件兜底
                try:
